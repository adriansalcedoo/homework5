...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
  ...
  public Void visitFunctionStmt(Stmt.Function stmt) {
    // Declare/define the function name in the current scope.
    declare(stmt.name);
    define(stmt.name);
  ...
  public Void visitAssignExpr(Expr.Assign expr) {
    ...
    // Assignment does NOT count as "read".
  ...
  // NEW signature: isRead determines whether to mark as READ.
