...
class Parser {
  ...
  private Stmt declaration() {
    try {
      // IMPORTANT CHANGE:
      // Only parse a function declaration statement if it's: fun IDENTIFIER ...
  ...
  // NEW helper: parses params/body and returns Expr.Function
  ...
  // NEW: one-token lookahead helper
